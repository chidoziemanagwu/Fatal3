...
// CORS Proxy Endpoint for Statcast Data
app.get('/api/statcast/:playerId', async (req, res) => {
...
// Fetch hitter projections from Fangraphs
...
// Fetch pitcher projections from Fangraphs
...
// Normalize data for player names
...
// Get current league ID from session
...
// Get taken players for a league
...
// Update the API endpoint for league rankings
...
// Add this endpoint to fetch historical stats
...
// Add this endpoint to fetch player positions
...
app.get('/api/proxy/statcast', async (req, res) => {
